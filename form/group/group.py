...
class newGroupForm(Form):
	...
	unit_price = DecimalField(u'到手单价', [InputRequired(),NumberRange(min=0,max=None,message='price >0')])
	list_price = DecimalField(u'原价', [InputRequired(),NumberRange(min=0,max=None,message='price >0')])
	total_qty = IntegerField(u'购买总数', [InputRequired(),NumberRange(min=1,max=None,message='qty>=1')])
